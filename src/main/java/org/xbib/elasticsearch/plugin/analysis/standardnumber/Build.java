...
public class Build {
    ...
    static {
        ...
        try {
            String pluginName = AnalysisStandardNumberPlugin.class.getName();
            Enumeration<URL> e = AnalysisStandardNumberPlugin.class.getClassLoader().getResources("es-plugin.properties");
